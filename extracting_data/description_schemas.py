...
class CVEducation(BaseModel):
    ...
    graduation_year: Optional[str] = Field(
        default=None, description="Graduation year or completion year."
    )
...
class CVDescription(BaseModel):
    ...
    full_name: Optional[str] = Field(
        default=None, description="Candidate full name as written in the CV."
    )
...
class JobDescription(BaseModel):
    ...
    company: Optional[str] = Field(
        default=None, description="Company or organization offering the job."
    )
    ...
    required_technical_skills: List[Skill] = Field(
        default_factory=list, description="Mandatory technical skills for the position."
    )
    nice_to_have_skills: List[Skill] = Field(
        default_factory=list, description="Optional or bonus technical skills."
    )

    other_requirements: List[str] = Field(
        default_factory=list, description="Non-skill requirements"
    )

    responsibilities: List[str] = Field(
        default_factory=list, description="Main responsibilities and tasks of the role."
    )
    ...
    role_summary: Optional[str] = Field(
        default=None, description="Short textual summary of the position."
    )
    ...
    required_certifications: List[str] = Field(
        default_factory=list, description="Mandatory certifications like AWS, PMP, CFA"
    )

    required_seniority: Optional[str] = Field(
        default=None, description="Required level of seniority "
    )
